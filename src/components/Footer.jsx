    ...
    >
      ...
      <Box
        sx={{
          height: 3,
          background:
            "linear-gradient(90deg, transparent, #c7d300, #9aa000, #c7d300, transparent)",
        }}
      />
      ...
      >
        <Box
          sx={{
            background:
              "linear-gradient(135deg, rgba(199,211,0,0.12) 0%, rgba(199,211,0,0.05) 100%)",
        ...
        >
          <Box sx={{ flex: 1 }}>
            ...
            >
              Join 50,000+ travelers getting handpicked offers straight to their
              inbox.
            </Typography>
          </Box>
        ...
        >
          ...
          <Box sx={{ flex: "0 0 26%", pr: { md: 4 } }}>
            ...
            >
              Your trusted partner for extraordinary holidays and seamless
              global visa services. We craft journeys that turn dreams into
              lifelong memories.
            </Typography>
              ...
              {[
                {
                  ...
                  text: "Chakalakkal junction, perumanoor road, Hilton lane, Thevara, Ernakulam. Pin: 682013",
                },
                {
              ...
              {[
                {
                  Icon: InstagramIcon,
                  label: "Instagram",
                  href: "https://www.instagram.com/loufiholidays?igsh=MW44NG41Zmk3bnA3cw==",
                },
                {
                  Icon: FacebookIcon,
                  label: "Facebook",
                ...
                <IconButton
                  ...
                  sx={{
                    ...
                    borderRadius: "10px",
                    "&:hover": {
                      background: "rgba(199,211,0,0.12)",
                      color: "#c7d300",
              ...
              {["IATA", "ATOL", "ISO 9001"].map((badge) => (
                <Box
                  ...
                  sx={{
                    ...
                    background: "rgba(199,211,0,0.05)",
                    fontSize: "0.72rem",
                    fontWeight: 700,
                    color: "#c7d300",
        ...
        >
          <Typography
            sx={{ color: "rgba(255,255,255,0.25)", fontSize: "0.82rem" }}
          >
